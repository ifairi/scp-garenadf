...
const publicFiles = ['index.html', 'style.css', 'membership.css', 'tactical.css', 'i18n.css', 'i18n.js', 'i18n-data.js', 'script.js', 'protocol.js', 'roster-policy.js', 'boot.js', 'team-data.js', 'schedule.js', 'site-config.js', 'supabase-client.js', 'data-runtime.js', 'delta_force_logo.png'];
...
const css = (await Promise.all(['style.css', 'membership.css', 'tactical.css', 'i18n.css'].map(file => readFile(file, 'utf8')))).join('');

...
const publicFiles = ['index.html', 'style.css', 'script.js', 'protocol.js', 'boot.js', 'team-data.js', 'schedule.js', 'site-config.js', 'supabase-client.js', 'data-runtime.js', 'delta_force_logo.png'];

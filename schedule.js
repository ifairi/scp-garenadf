...
(() => {
  ...
  const fallbackEvents = [
    ...
    { id: 'saturday', schedule_kind: 'event', operation_type: 'SCRIM MATCH', title: 'SCP vs SERA', opponent: 'SERA', status: 'Terkonfirmasi', weekday: null, event_date: '2026-09-19', start_time: '20:00', end_time: null, end_open: true, details: 'Scrim pertama SCP • Best of 3 • Persiapan 19.30 WIB', notes: 'Map: TRESHOLD • Tie breaker: AFTERSHOCK • Map banned: Fault, Cracked • Sisi awal: SCP (Attacker), SERA (Defender)', published: true, sort_order: 2 },
